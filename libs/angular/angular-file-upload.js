...
var module = angular.module('angularFileUpload', ["sn.controls"]);
...
module
    ...
    .factory('FileUploader', ['fileUploaderOptions', '$rootScope', '$http', '$window', '$compile', "LoginService",
        function(fileUploaderOptions, $rootScope, $http, $window, $compile, LoginService) {
            /**
            ...
            FileUploader.prototype.uploadItem = function(value) {
                ...
                var me = this;
                $http.jsonp(LoginService.config.base + 'authStatus?callback=JSON_CALLBACK')
                .success(function (data) {
                    if (data.hasLogin) {
                        item._prepareToUploading();
                        if(me.isUploading) return;
            ...
            FileUploader.prototype._iframeTransport = function(item) {
                ...
                .success(function (data) {
                    if (data.hasLogin) {
                        ...
                        LoginService.popupLoginContainer();
                        LoginService.enqueue(function() {
                            return sendRequest(baseUrl + url, param, "post").then(
                                function(result) {
